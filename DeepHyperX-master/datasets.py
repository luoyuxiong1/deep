...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == "PaviaC":
        ...
        rgb_bands = (28, 19, 11)  # AVIRIS sensor
        ...
        # rgb_bands = (43, 21, 11)  # AVIRIS sensor
        rgb_bands = (20, 21, 11)  # AVIRIS sensor
        ...
        # Load the image
        img = open_file(folder + "2013_IEEE_GRSS_DF_Contest_CASI_349_1905_144.mat")["grss"]
        ...
        # rgb_bands = (120, 72, 36)
        rgb_bands = [28, 20, 12]  # to be edited

        gt = open_file(folder + "Loukia_GT.mat")["map"]
        label_values = [
            'Undefined',
            'Dense Urban Fabric',
